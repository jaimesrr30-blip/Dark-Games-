...
export const MISSIONS: MissionDef[] = [
  ...
  {
    id: "s_cofres_asteroides",
    type: "secundaria",
    stage: "cinturon_asteroides",
    title: "Rocas con Valor",
    giver: "mercader_asteroides",
    description: "Encuentra 3 cofres escondidos en el Cinturón de Asteroides.",
    objectives: [{ type: "recogerCofres", target: "cinturon_asteroides", count: 3, description: "Encuentra 3 cofres" }],
    rewardMonedas: 10000,
    rewardDiamantes: 320,
    rewardXp: 4200,
  },
  {
    id: "s_goles_asteroides",
    type: "secundaria",
    stage: "cinturon_asteroides",
    title: "Puntería a la Deriva",
    giver: "superviviente_cinturon",
    description: "Marca 8 goles en cualquier partido.",
    objectives: [{ type: "marcarGoles", target: "any", count: 8, description: "Marca 8 goles" }],
    rewardMonedas: 10000,
    rewardDiamantes: 320,
  ...
  {
    id: "s_partido_asteroides",
    type: "secundaria",
    stage: "cinturon_asteroides",
    title: "Entrénate entre las Rocas",
    giver: "tecnica_navegacion",
    description: "Gana un partido de entrenamiento en el Cinturón de Asteroides.",
    objectives: [{ type: "ganarPartido", target: "campo_cinturon_asteroides", count: 1, description: "Gana un partido de entrenamiento" }],
    rewardMonedas: 10000,
    rewardDiamantes: 320,
    rewardXp: 4200,
  },
  {
    id: "m_asteroides_jefe",
    type: "principal",
    stage: "cinturon_asteroides",
    title: "El Hambre del Cinturón",
    giver: "sistema",
    description: "Derrota al Fragmento Devorador. Puede matarte: ten cuidado.",
    objectives: [{ type: "derrotarJefe", target: "cinturon_asteroides", count: 1, description: "Derrota al Fragmento Devorador" }],
    rewardMonedas: 20000,
    rewardDiamantes: 550,
    rewardXp: 7500,
  },
  ...
  // ---------- Horizonte de un Agujero Negro ----------
  {
    ...
    type: "secundaria",
    stage: "agujero_negro",
    title: "Reliquias al Borde del Vacío",
    giver: "mercader_horizonte",
    description: "Encuentra 3 cofres escondidos en el Horizonte de un Agujero Negro.",
    objectives: [{ type: "recogerCofres", target: "agujero_negro", count: 3, description: "Encuentra 3 cofres" }],
    rewardMonedas: 13000,
    rewardDiamantes: 400,
    rewardXp: 5200,
  },
  {
    ...
    type: "secundaria",
    stage: "agujero_negro",
    title: "Puntería junto a la Singularidad",
    giver: "ultimo_testigo",
    description: "Marca 8 goles en cualquier partido.",
    objectives: [{ type: "marcarGoles", target: "any", count: 8, description: "Marca 8 goles" }],
    rewardMonedas: 13000,
    rewardDiamantes: 400,
  ...
  {
    id: "s_partido_agujero",
    type: "secundaria",
    stage: "agujero_negro",
    title: "Entrénate al Borde del Horizonte",
    giver: "tecnica_contencion",
    description: "Gana un partido de entrenamiento en el Horizonte de un Agujero Negro.",
    objectives: [{ type: "ganarPartido", target: "campo_agujero_negro", count: 1, description: "Gana un partido de entrenamiento" }],
    rewardMonedas: 13000,
    rewardDiamantes: 400,
    rewardXp: 5200,
  },
  {
    ...
    type: "principal",
    stage: "agujero_negro",
    title: "Lo que Queda al Otro Lado",
    giver: "sistema",
    description: "Derrota a la Singularidad Consciente. Puede matarte: ten cuidado.",
    objectives: [{ type: "derrotarJefe", target: "agujero_negro", count: 1, description: "Derrota a la Singularidad Consciente" }],
    rewardMonedas: 26000,
    rewardDiamantes: 700,
    rewardXp: 9000,
  },
