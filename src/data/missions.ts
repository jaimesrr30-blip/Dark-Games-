...
export const MISSIONS: MissionDef[] = [
  ...
  // ---------- Naves locales de los planetas ----------
  {
    id: "s_piezas_nave_escarlata",
    type: "secundaria",
    stage: "planeta_escarlata",
    title: "Piezas de una Nave Olvidada",
    giver: "mecanico_polvo",
    description: "Encuentra las 3 piezas de nave escondidas por el Planeta Escarlata.",
    objectives: [{ type: "recogerPiezas", target: "planeta_escarlata", count: 3, description: "Encuentra las 3 piezas de nave" }],
    rewardMonedas: 2500,
    rewardDiamantes: 70,
    rewardXp: 900,
  },
  {
    ...
    type: "principal",
    stage: "planeta_escarlata",
    title: "Rumbo a los Anillos",
    giver: "mecanico_polvo",
    description: "Lleva las 3 piezas al Mecánico del Polvo tras derrotar a Vorrak para reconstruir la nave.",
    objectives: [{ type: "hablarCon", target: "mecanico_polvo", count: 1, description: "Habla con el Mecánico del Polvo con todo listo" }],
    rewardMonedas: 4500,
    rewardDiamantes: 130,
    rewardXp: 1800,
    requires: ["s_piezas_nave_escarlata", "m_escarlata_jefe"],
  },
  {
    id: "s_piezas_nave_anillos",
    type: "secundaria",
    stage: "planeta_anillos",
    title: "Piezas entre las Nubes",
    giver: "mecanica_flotante",
    description: "Encuentra las 3 piezas de nave escondidas por los Anillos de Kaion.",
    objectives: [{ type: "recogerPiezas", target: "planeta_anillos", count: 3, description: "Encuentra las 3 piezas de nave" }],
    rewardMonedas: 3000,
    rewardDiamantes: 85,
    rewardXp: 1000,
  },
  {
    ...
    type: "principal",
    stage: "planeta_anillos",
    title: "Rumbo a la Luna de Cristal",
    giver: "mecanica_flotante",
    description: "Lleva las 3 piezas a la Mecánica Flotante tras derrotar a Nébula-9 para reconstruir la nave.",
    objectives: [{ type: "hablarCon", target: "mecanica_flotante", count: 1, description: "Habla con la Mecánica Flotante con todo listo" }],
    rewardMonedas: 5500,
    rewardDiamantes: 160,
    rewardXp: 2200,
    requires: ["s_piezas_nave_anillos", "m_anillos_jefe"],
  },
  {
    id: "s_piezas_nave_cristal",
    type: "secundaria",
    stage: "planeta_cristal",
    title: "Piezas de un Eco Antiguo",
    giver: "arquitecto_cristal",
    description: "Encuentra las 3 piezas de nave escondidas por la Luna de Cristal.",
    objectives: [{ type: "recogerPiezas", target: "planeta_cristal", count: 3, description: "Encuentra las 3 piezas de nave" }],
    rewardMonedas: 3500,
    rewardDiamantes: 100,
    rewardXp: 1200,
  },
  {
    ...
    type: "principal",
    stage: "planeta_cristal",
    title: "El Fin del Viaje... por Ahora",
    giver: "arquitecto_cristal",
    description: "Lleva las 3 piezas a la Arquitecta de Cristal tras derrotar a Prisma Eterna.",
    objectives: [{ type: "hablarCon", target: "arquitecto_cristal", count: 1, description: "Habla con la Arquitecta de Cristal con todo listo" }],
    rewardMonedas: 9000,
    rewardDiamantes: 300,
    rewardXp: 4000,
    requires: ["s_piezas_nave_cristal", "m_cristal_jefe"],
  },

  // ---------- El traje espacial (puerta al espacio profundo) ----------
  {
    id: "m_traje_espacial",
    type: "principal",
    stage: "planeta_cristal",
    title: "Sin Vuelta Atrás",
    giver: "ingeniera_trajes",
    description: "Habla con la Ingeniera Orbital Kess para craftear un traje espacial. Más allá de la Luna de Cristal, se puede morir de verdad.",
    objectives: [{ type: "hablarCon", target: "ingeniera_trajes", count: 1, description: "Craftea tu traje espacial" }],
    rewardMonedas: 3000,
    rewardDiamantes: 100,
    rewardXp: 1500,
    requires: ["m_nave_cristal", "m_cristal_jefe"],
  },

  // ---------- Estación Óxido (espacio profundo) ----------
  {
    id: "s_cofres_estacion",
    type: "secundaria",
    stage: "estacion_oxido",
    title: "Chatarra con Valor",
    giver: "mercader_oxido",
    description: "Encuentra 3 cofres escondidos en la Estación Óxido.",
    objectives: [{ type: "recogerCofres", target: "estacion_oxido", count: 3, description: "Encuentra 3 cofres" }],
    rewardMonedas: 3200,
    rewardDiamantes: 80,
    rewardXp: 800,
  },
  {
    ...
    type: "secundaria",
    stage: "estacion_oxido",
    title: "Puntería en Gravedad Cero",
    giver: "superviviente_oxido",
    description: "Marca 8 goles en cualquier partido.",
    objectives: [{ type: "marcarGoles", target: "any", count: 8, description: "Marca 8 goles" }],
    rewardMonedas: 3200,
    rewardDiamantes: 80,
  ...
  {
    id: "s_partido_estacion",
    type: "secundaria",
    stage: "estacion_oxido",
    title: "Entrénate en la Estación",
    giver: "tecnica_soporte",
    description: "Gana un partido de entrenamiento en la Estación Óxido.",
    objectives: [{ type: "ganarPartido", target: "campo_estacion_oxido", count: 1, description: "Gana un partido de entrenamiento" }],
    rewardMonedas: 3200,
    rewardDiamantes: 80,
    rewardXp: 800,
  },
  {
    ...
    type: "principal",
    stage: "estacion_oxido",
    title: "El Último Sistema",
    giver: "sistema",
    description: "Derrota al Custodio Corroído. Puede matarte: ten cuidado.",
    objectives: [{ type: "derrotarJefe", target: "estacion_oxido", count: 1, description: "Derrota al Custodio Corroído" }],
    rewardMonedas: 9000,
    rewardDiamantes: 280,
    rewardXp: 3800,
  },
