...
export const NPCS: NpcDef[] = [
  ...
  // ---------------- Cinturón de Asteroides Fracturado (espacio profundo) ----------------
  {
    id: "piloto_saltador",
    name: "Piloto Saltador",
    stage: "cinturon_asteroides",
    pos: [950, -750],
    color: "#8a94a8",
    role: "guardian",
    suited: true,
    dialogue: ["Aquí no hay puentes. Solo huecos entre rocas que se alejan un poco más cada día.", "Salta o cae. Así de simple. Así de justo."],
    guardian: guardian("key_cinturon_asteroides_1", 0, 1.26),
  },
  {
    id: "centinela_fractura",
    name: "Centinela de la Fractura",
    stage: "cinturon_asteroides",
    pos: [-1000, 800],
    color: "#6a7080",
    role: "guardian",
    suited: true,
    dialogue: ["Cada roca de este campo se desintegra dos segundos después de que la pisas. No es maldad. Es física.", "Cruza sin quedarte quieto y la llave es tuya."],
    guardian: guardian("key_cinturon_asteroides_2", 0, 1.28),
  },
  {
    id: "vigia_minero",
    name: "Vigía del Puesto Minero",
    stage: "cinturon_asteroides",
    pos: [0, -1150],
    color: "#8fa8b8",
    role: "guardian",
    suited: true,
    dialogue: ["Los escáneres de seguridad siguen activos aunque no quede nada que proteger.", "Encuentra el hueco entre los haces y habrás ganado esta llave con las manos limpias."],
    guardian: guardian("key_cinturon_asteroides_3", 0, 1.3),
  },
  {
    id: "mercader_asteroides",
    name: "Mercader de Rocas Preciosas",
    stage: "cinturon_asteroides",
    pos: [-260, 200],
    color: "#a8b0c0",
    role: "tienda",
    shopId: "shop_cinturon_asteroides",
    suited: true,
    dialogue: ["Cada roca de este cinturón esconde algo valioso. El truco es sobrevivir para recogerlo."],
    missionIds: ["s_cofres_asteroides"],
  },
  {
    id: "cazador_chatarra_espacial",
    name: "Cazador de Chatarra Espacial",
    stage: "cinturon_asteroides",
    pos: [280, 240],
    color: "#c0c8d8",
    role: "mascotas",
    suited: true,
    dialogue: ["Las criaturas que sobreviven a la deriva entre rocas valen una fortuna. Enséñame la tuya."],
  },
  {
    id: "superviviente_cinturon",
    name: "Superviviente del Cinturón",
    stage: "cinturon_asteroides",
    pos: [0, -340],
    color: "#e8f4ff",
    role: "historia",
    suited: true,
    dialogue: [
      "Cada sello que rompes en cada mundo despierta algo más. Aquí lo sentimos primero: las rocas ya no giraban igual antes de que llegaras.",
      "Cada vez queda menos gente dispuesta a cruzar este cinturón. Los que llegan hasta aquí, casi nunca vuelven a hablar de otra cosa.",
      "Más allá de estas rocas hay algo que dobla la luz misma. Y más allá de eso, dicen, está el Sol y su Brecha.",
    ],
    missionIds: ["s_goles_asteroides"],
  },
  {
    id: "tecnica_navegacion",
    name: "Técnica de Navegación",
    stage: "cinturon_asteroides",
    pos: [400, -100],
    color: "#7bd6c9",
    role: "mision",
    suited: true,
    dialogue: ["Calculo trayectorias entre rocas para quien se atreve a cruzar. Las tuyas, de momento, van bien.", "Practica en el simulador antes de intentar algo de verdad peligroso."],
    missionIds: ["s_partido_asteroides"],
  },

  // ---------------- Horizonte de un Agujero Negro (espacio profundo) ----------------
  {
    id: "vigia_horizonte",
    name: "Vigía del Horizonte",
    stage: "agujero_negro",
    pos: [950, -750],
    color: "#ff8a3d",
    role: "guardian",
    suited: true,
    dialogue: ["Cerca de la singularidad, hasta la luz se curva. Estos filamentos giran más rápido de lo que deberían.", "Si cruzas sin que te toquen, mi llave es tuya. Casi nadie lo consigue."],
    guardian: guardian("key_agujero_negro_1", 0, 1.32),
  },
  {
    id: "tecnico_singularidad",
    name: "Técnico de la Singularidad",
    stage: "agujero_negro",
    pos: [-1000, 800],
    color: "#c9701f",
    role: "guardian",
    suited: true,
    dialogue: ["Las compuertas de contención colapsan cada vez más rápido cuanto más cerca estás del centro.", "Cronométrate perfecto o vuélvete parte de la singularidad."],
    guardian: guardian("key_agujero_negro_2", 0, 1.34),
  },
  {
    id: "centinela_vacio_absoluto",
    name: "Centinela del Vacío Absoluto",
    stage: "agujero_negro",
    pos: [0, -1150],
    color: "#3a1a5a",
    role: "guardian",
    suited: true,
    dialogue: ["Aquí el espacio se rasga de verdad. Las pistas de salto son más cortas que en cualquier otro lugar.", "Si dudas un instante, la fractura decide por ti."],
    guardian: guardian("key_agujero_negro_3", 0, 1.36),
  },
  {
    id: "mercader_horizonte",
    name: "Mercader del Horizonte",
    stage: "agujero_negro",
    pos: [-260, 200],
    color: "#ff8a3d",
    role: "tienda",
    shopId: "shop_agujero_negro",
    suited: true,
    dialogue: ["Todo lo que vendo aquí sobrevivió a la gravedad que se lo llevó todo. Incluido yo, de momento."],
    missionIds: ["s_cofres_agujero"],
  },
  {
    id: "coleccionista_eco",
    name: "Coleccionista de Ecos",
    stage: "agujero_negro",
    pos: [280, 240],
    color: "#6a3fa0",
    role: "mascotas",
    suited: true,
    dialogue: ["Las criaturas que viven al borde de la singularidad son un eco de sí mismas. Te pago bien por una."],
  },
  {
    id: "ultimo_testigo",
    name: "Último Testigo",
    ...
    suited: true,
    dialogue: [
      "Ocho sellos rotos en la Tierra. Tres planetas cruzados. Una estación de óxido. Este agujero negro. Ya casi no queda historia sin contar antes del Sol.",
      "Cada vez queda menos gente, piloto. Yo soy, que yo sepa, el último testigo de todo lo que pasó antes de que llegaras.",
      "Cruza esto y solo te quedará el Sol. Y detrás del Sol... eso ya no lo sé ni yo. Nadie lo sabe. Todavía.",
    ],
    missionIds: ["s_goles_agujero"],
  },
  {
    id: "tecnica_contencion",
    name: "Técnica de Contención",
    stage: "agujero_negro",
    pos: [400, -100],
    color: "#7bd6c9",
    role: "mision",
    suited: true,
    dialogue: ["Contengo lo que se puede contener. No es mucho, cerca de una singularidad.", "Entrena aquí si quieres, aunque dudo que sirva de mucho contra lo que viene."],
    missionIds: ["s_partido_agujero"],
  },
